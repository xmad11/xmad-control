      ...
      {Array.from({ length: lines }).map((_, index) => (
        <div
          ...
          className={cn(
            ...
            index === 0 && animated ? "animate-shimmer bg-shimmer-gradient" : ""
          )}
        />
      ))}
    </div>
  ...
  return (
    <div className={cn("flex space-x-[var(--spacing-sm)]", className)}>
      {Array.from({ length: count }).map((_, index) => (
        <div
          key={`stagger-${index}`}
          className={`w-[var(--icon-size-xs)] h-[var(--icon-size-xs)] bg-[var(--color-primary)] rounded-[var(--radius-full)] animate-bounce stagger-delay-${index}`}
        />
      ))}
    </div>
  )
    ...
    <div className={cn("space-y-[var(--spacing-md)]", className)}>
      {Array.from({ length: lines }).map((_, index) => (
        <div
          ...
          className="flex items-center space-x-[var(--spacing-md)]"
        >
