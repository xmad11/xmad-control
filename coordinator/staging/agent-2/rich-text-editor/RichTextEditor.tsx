          ...
          <div className="flex flex-wrap items-center gap-[var(--spacing-xs)] p-[var(--spacing-sm)] bg-[var(--bg)] border border-[var(--fg-10)] rounded-[var(--radius-lg)]">
            ...
            <div className="flex items-center gap-[var(--spacing-xs)]">
              ...
              <ToolbarButton onClick={removeLink} title="Remove Link">
                <span className="text-[var(--font-size-xs)] font-medium">Unlink</span>
              </ToolbarButton>
            </div>
          </div>
        )}
...
export function RichTextEditorField({
  ...
  return (
    <div className="flex flex-col gap-[var(--spacing-xs)]">
      <label className="flex items-center gap-[var(--spacing-xs)] text-[var(--font-size-sm)] font-medium text-[var(--fg)]">
        {label}
        {required && <span className="text-[var(--color-error)]">*</span>}
      </label>
      <RichTextEditor value={value} onChange={onChange} {...editorProps} />
      {helperText && !error && (
