...
**Copied:** 2026-02-10
**Destination:** `/Users/ahmadabdullah/.openclaw/workspace/`
...
```bash
cd /Users/ahmadabdullah/.openclaw/workspace/stt-sensevoice
python api.py
...
```bash
cd /Users/ahmadabdullah/.openclaw/workspace/tts-chatterbox
python server.py
