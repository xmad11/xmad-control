// ~/xmad-control/modules/core/packages/stt-tts/index.js
// STT: Groq Whisper (fastest, free tier, streams in)
// TTS: ElevenLabs streaming (never buffered in RAM)
// Memory cost: ~0 — all data piped, never held
...
async function transcribe(audioFilePath, language = "en") {
  ...
  const res = await new Promise((resolve, reject) => {
    ...
    fileStream.on("end", () => { req.write(footerBuf); req.end(); });
