...
export function HomeClient() {
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
      <main
        id="main-content"
        className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] p-[var(--spacing-xl)]"
      >
        <h1 className="text-[var(--font-size-5xl)] font-bold">XMAD Control</h1>
